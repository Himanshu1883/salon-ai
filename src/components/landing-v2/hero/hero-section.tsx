  ...
  return (
    <section className="hero-editorial relative h-full overflow-x-hidden">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        {/* <div className="absolute inset-0 bg-gradient-to-r from-[#F7F3EC]/20 via-[#F7F3EC]/10 to-[#F7F3EC]/0" /> */}
        <div className="hero-editorial__grain absolute inset-0 opacity-100" />
      </div>
      ...
      <div className="relative mx-auto flex h-full min-h-0 max-w-7xl flex-col items-center justify-center gap-4 px-5 pb-[7.25rem] pt-[calc(var(--landing-nav-h)+1rem)] sm:gap-5 sm:px-6 sm:pb-[7.5rem] sm:pt-[calc(var(--landing-nav-h)+1.25rem)] lg:flex-row lg:gap-6 lg:px-8 lg:pb-[calc(var(--landing-trust-half)+0.5rem)] lg:pt-[calc(var(--landing-nav-h)+0.75rem)] xl:gap-8">
        ...
        {/* Copy & CTAs */}
        <div className="z-10 w-full flex-shrink-0 text-center lg:max-w-xl lg:flex-1 lg:text-left relative">
          
          {/* WHITE GLOWING BLUR BEHIND THE TEXT */}
          <div className="absolute -inset-4 -top-10 bg-white/40 blur-[40px] rounded-[60px] pointer-events-none z-0 lg:-inset-8" />

          <motion.div
            data-motion=""
            {...fadeUp(0, reduced)}
            className="relative z-10 mb-2 flex items-center justify-center gap-2.5 lg:mb-4 lg:justify-start lg:gap-3"
          >
          ...
          <motion.h1
            ...
            className="relative z-10 hero-editorial__headline text-[1.625rem] font-semibold leading-[1.12] tracking-tight text-[#1B1714] sm:text-[1.875rem] sm:leading-[1.1] md:text-4xl lg:text-[2.75rem] lg:leading-[1.08] xl:text-[3.25rem]"
            style={{
              textShadow: "0 4px 30px rgba(255, 255, 255, 0.6), 0 2px 10px rgba(255, 255, 255, 0.8)"
            }}
          >
            {HERO.headline}{" "}
          ...
          <motion.p
            ...
            className="relative z-10 mx-auto mt-3 max-w-[20rem] text-sm font-medium leading-relaxed text-[#1B1714] sm:mt-4 sm:max-w-md sm:text-[15px] md:text-base lg:mx-0 lg:max-w-xl"
            style={{
          ...
          <motion.div
            ...
            className="relative z-10 mt-4 hidden flex-wrap justify-center gap-2 min-[720px]:flex lg:justify-start"
          >
          ...
          <motion.div
            ...
            className="relative z-10 mx-auto mt-4 flex w-full max-w-sm flex-col gap-2.5 sm:mt-5 sm:max-w-md sm:gap-3 lg:mx-0 lg:mt-6 lg:max-w-none lg:flex-row lg:justify-start"
          >
            <Link
              href="/register"
