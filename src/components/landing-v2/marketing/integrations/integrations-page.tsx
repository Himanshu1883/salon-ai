...
/** Real integrations / connected capabilities from Salon AI product */
const WORKFLOWS = [
  {
    id: "messaging",
        ...
        <div className={CONTAINER}>
          <Reveal>
            <h2 className="landing-display max-w-2xl text-3xl font-medium tracking-tight text-[#1B1714] md:text-4xl">
              Pick your workflow. See Salon AI at work.
            </h2>
          </Reveal>
        ...
        <div className={CONTAINER}>
          <Reveal className="max-w-2xl">
            ...
            <p className="mt-4 text-base text-[#1B1714]/60">
              ...
              Salon AI and share the same client, staff, and billing data.
            </p>
          </Reveal>
