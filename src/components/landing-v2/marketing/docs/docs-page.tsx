...
const DOC_TOPICS = [
  {
    ...
    description:
      "First-time with GlowDesk? We walk you from signup to your first booked appointment.",
...
const PROCESS_STEPS = [
  {
    ...
    body: "GlowDesk documentation is written around real floor workflows — not generic SaaS jargon. Every guide maps to how stylists, reception, and owners actually work.",
    cta: "How It Works",
    href: "#process",
  },
  {
...
const STATS = [
  ...
  },
  {
    ...
    label: "Salons using GlowDesk documentation daily",
  },
];
          ...
          <div className="max-w-4xl">
            <Reveal>
              <h1 className="landing-display text-[2.25rem] font-medium leading-[1.1] tracking-tight sm:text-5xl md:text-6xl lg:text-[3.75rem]">
                The best way to set up and run your salon on GlowDesk
              </h1>
            </Reveal>
            <Reveal delay={0.1}>
