...
const COLUMNS = [
  {
    ...
    links: [
      ...
      { label: "AI Analytics", to: "/ai" },
      { label: "Integrations", to: "/platform" },
      { label: "API", to: "/platform" },
      { label: "Changelog", to: "/platform" },
    ],
  },
  {
    title: "Company",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Community", to: "/testimonials" },
      { label: "Roadmap", to: "/platform" },
      { label: "Webinars", to: "/platform" },
      { label: "Guides", to: "/platform" },
    ],
  },
  {
    title: "Legal",
    links: [
      ...
      { label: "Data Processing", to: "/privacy" },
    ],
  },
] as const;
...
const SOCIALS = [
  ...
  { Icon: Facebook, label: "Facebook", color: "hover:text-blue-700" },
];
      ...
      <div className="relative z-10 w-full px-6 py-8 lg:px-12">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <Link to="/privacy" className="transition-colors hover:text-[#2d1f3d]">
              Privacy
            </Link>
            <span className="h-3 w-px bg-[#d5cce6]/60" />
            <Link to="/terms" className="transition-colors hover:text-[#2d1f3d]">
              Terms
            </Link>
            <span className="h-3 w-px bg-[#d5cce6]/60" />
            <Link to="/security" className="transition-colors hover:text-[#2d1f3d]">
              Security
            </Link>
            <span className="h-3 w-px bg-[#d5cce6]/60" />
            <Link to="/sitemap" className="transition-colors hover:text-[#2d1f3d]">
              Sitemap
            </Link>
          </div>
        </motion.div>
